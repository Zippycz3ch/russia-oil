                        ...
                        {showAddHitForm === -1 && (
                            <div style={{
                                ...
                                <form onSubmit={(e) => {
                                    ...
                                    <div>
                                        <label style={{ color: '#999', display: 'block', marginBottom: '5px' }}>Severity *</label>
                                        <select
                                            value={newHit.severity}
                                            onChange={(e) => setNewHit({ ...newHit, severity: e.target.value as 'damaged' | 'destroyed' })}
                                            style={{
                                                width: '100%',
                                                padding: '10px',
                                                backgroundColor: '#0a0a0a',
                                    ...
                                    <div style={{ gridColumn: '1 / -1' }}>
                                        <label style={{ color: '#999', display: 'block', marginBottom: '10px' }}>Media Links (Videos/Photos)</label>
                                        {newHit.mediaLinks?.map((link, index) => (
                                            <div key={index} style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                                                <input
                                                    type="url"
                                                    value={link}
                                                    onChange={(e) => {
                                                        const updated = [...(newHit.mediaLinks || [])];
                                                        updated[index] = e.target.value;
                                                        setNewHit({ ...newHit, mediaLinks: updated });
                                                    }}
                                                    placeholder="https://..."
                                                    style={{
                                                        flex: 1,
                                                ...
                                                {index > 0 && (
                                                    <button
                                                        type="button"
                                                        onClick={() => {
                                                            const updated = newHit.mediaLinks?.filter((_, i) => i !== index);
                                                            setNewHit({ ...newHit, mediaLinks: updated });
                                                        }}
                                                        style={{
                                                            padding: '10px 15px',
                                        ...
                                        <button
                                            type="button"
                                            onClick={() => setNewHit({ ...newHit, mediaLinks: [...(newHit.mediaLinks || []), ''] })}
                                            style={{
                                                padding: '8px 16px',
                                                backgroundColor: '#333',
                                                color: '#fff',
