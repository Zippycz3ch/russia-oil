            ...
            <div style={{ flex: 1, position: 'relative' }}>
                ...
                {capitals.map((capital) => {
                    ...
                    if (capital.name === "Moscow") {
                        ...
                        // 5-point star with Ukrainian flag colors (horizontal 55/45 split - blue 55%, yellow 45%)
                        icon = L.divIcon({
                            className: 'capital-marker',
                            html: `<div style="
                                width: 24px; 
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" style="display: block;">
                                    <defs>
                                        <linearGradient id="ukraineFlag" x1="0%" y1="0%" x2="0%" y2="100%">
                                            <stop offset="55%" style="stop-color:${capital.colors.top};stop-opacity:1" />
                                            <stop offset="55%" style="stop-color:${capital.colors.bottom};stop-opacity:1" />
                                        </linearGradient>
                                    </defs>
                                    <path d="M12 2 L15.09 8.26 L22 9.27 L17 14.14 L18.18 21.02 L12 17.77 L5.82 21.02 L7 14.14 L2 9.27 L8.91 8.26 Z" 
