...
// Routes for managing hits on facilities
router.post('/:id/hits', facilitiesController.addHit);
router.get('/:id/hits', facilitiesController.getHits);
router.put('/:id/hits/:hitId', facilitiesController.updateHit);
router.delete('/:id/hits/:hitId', facilitiesController.deleteHit);
